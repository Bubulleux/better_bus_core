...
class FeedHeader_Incrementality extends $pb.ProtobufEnum {
  ...
  static final $core.List<FeedHeader_Incrementality?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static FeedHeader_Incrementality? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class TripUpdate_StopTimeUpdate_ScheduleRelationship extends $pb.ProtobufEnum {
  ...
  static final $core.List<TripUpdate_StopTimeUpdate_ScheduleRelationship?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static TripUpdate_StopTimeUpdate_ScheduleRelationship? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const TripUpdate_StopTimeUpdate_ScheduleRelationship._(super.value, super.name);
}

class TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType extends $pb.ProtobufEnum {
  /// Regularly scheduled pickup/dropoff.
  static const TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType REGULAR = TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType._(0, _omitEnumNames ? '' : 'REGULAR');
  /// No pickup/dropoff available
  static const TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType NONE = TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType._(1, _omitEnumNames ? '' : 'NONE');
  /// Must phone agency to arrange pickup/dropoff.
  static const TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType PHONE_AGENCY = TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType._(2, _omitEnumNames ? '' : 'PHONE_AGENCY');
  /// Must coordinate with driver to arrange pickup/dropoff.
  static const TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType COORDINATE_WITH_DRIVER = TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType._(3, _omitEnumNames ? '' : 'COORDINATE_WITH_DRIVER');

  static const $core.List<TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType> values = <TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType> [
    REGULAR,
    NONE,
    PHONE_AGENCY,
  ...
  static final $core.List<TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType._(super.value, super.name);
}
...
class VehiclePosition_VehicleStopStatus extends $pb.ProtobufEnum {
  ...
  static final $core.List<VehiclePosition_VehicleStopStatus?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static VehiclePosition_VehicleStopStatus? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class VehiclePosition_CongestionLevel extends $pb.ProtobufEnum {
  ...
  static final $core.List<VehiclePosition_CongestionLevel?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static VehiclePosition_CongestionLevel? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class VehiclePosition_OccupancyStatus extends $pb.ProtobufEnum {
  ...
  static final $core.List<VehiclePosition_OccupancyStatus?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 8);
  static VehiclePosition_OccupancyStatus? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Alert_Cause extends $pb.ProtobufEnum {
  ...
  static final $core.List<Alert_Cause?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 12);
  static Alert_Cause? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Alert_Effect extends $pb.ProtobufEnum {
  ...
  static final $core.List<Alert_Effect?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 11);
  static Alert_Effect? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Alert_SeverityLevel extends $pb.ProtobufEnum {
  ...
  static final $core.List<Alert_SeverityLevel?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static Alert_SeverityLevel? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class TripDescriptor_ScheduleRelationship extends $pb.ProtobufEnum {
  ...
  /// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
  static const TripDescriptor_ScheduleRelationship NEW = TripDescriptor_ScheduleRelationship._(8, _omitEnumNames ? '' : 'NEW');
  ...
  static final $core.List<TripDescriptor_ScheduleRelationship?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 8);
  static TripDescriptor_ScheduleRelationship? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class VehicleDescriptor_WheelchairAccessible extends $pb.ProtobufEnum {
  ...
  static final $core.List<VehicleDescriptor_WheelchairAccessible?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static VehicleDescriptor_WheelchairAccessible? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Stop_WheelchairBoarding extends $pb.ProtobufEnum {
  ...
  static final $core.List<Stop_WheelchairBoarding?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Stop_WheelchairBoarding? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
